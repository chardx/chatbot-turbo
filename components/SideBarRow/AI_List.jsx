...
const AI_List = () => {
  const DUMMY_ROLES = [
    ...
    {
      id: "r2",
      AIName: "Javris - Your friendly Javascript expert",
      description: "You can ask anything about the Software Developemtn",
      content:
    ...
    },
    {
      ...
      description: "You can ask anything about the Software Developement",
      content:
  ...
  return (
    <div className="bg-gray-100 py-8 text-black">
