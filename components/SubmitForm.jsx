...
const SubmitForm = ({
  ...
  return (
    <div className="fixed md:absolute bottom-2 flex h-30 w-full max-w-7xl justify-center items-center px-4 mx-2 mt-6">
      <FileUploader
      ...
      <textarea
        ...
        onFocus={handleFocus}
      />
      <div className="flex flex-row justify-center gap-0 px-2">
        <VoiceCommand />
